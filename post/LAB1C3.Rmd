...
Os dados que serão analisados a seguir, são dados referentes as séries presentes no IMDB. O IMDB é um site que contém diversas informações sobre séries, filmes, celebridades etc. O conteúdo utilizado nas analises a seguir pode ser encontrado em https://github.com/nazareno/imdb-series.
...
Podemos perceber que a quantidade de espectadores não crescem/decrescem ao passo que as notas crescem/decrescem, apenas na série The Simpsons houve essa relação, pois ao passo que a nota cresceu a quantidade de espectadores tbm cresceu.
...
Séra qua a quantidade de espectadores que votam em determinada série influenciam no valore final da nota geral atribuída a elas? Vamos considerar as séries com mais de 400 episódios para responder essa questão.
...
Como podemos perceber, não existe uma verdade absoluta entre a quantidade de espectadores e a nota final da série, pois na série American Idol ao passo que a quantidade de votos aumentaram a nota subiu consideravelmente, porém na série Law e Order ao passo que a quantidade de votos aumentou a nota decresceu consideravelmente. Nesse caso, podemos inferir que a quantidade de votos não influência de forma geral a nota final da série, mas influencia, apenas individualmente, cada série.
